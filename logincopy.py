...
class Login_system:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Allen Management System", font=("times", 35, "italic bold"), bg="navy",
                      fore="cyan", bd=10, relief=GROOVE)
        ...
        user = Label(Login_Frame, text="User Name", image=self.user_icon, compound=LEFT, bg="white",
                     font=("times", 20, "italic bold")).grid(row=1, column=0, padx=20, pady=10)
        Password = Label(Login_Frame, text="Password", image=self.pass_icon, compound=LEFT, bg="white",
                         font=("times", 20, "italic bold")).grid(row=2, column=0, padx=20, pady=10)
        ...
        loginbutt = Button(Login_Frame, text="Login", width=15, font=("times", 15, "italic bold"), relief=RIDGE, bd=5,
                           bg="cyan4",
                           activebackground="green", activeforeground="blue", command=self.login).grid(row=3, column=1,
                                                                                                       pady=10)

        newacc = Button(Login_Frame, text="Requierd New Account ?", width=20, font=("times", 12, "italic"), bg="white",
                        borderwidth=0,
