...
def addresut():
    def Subresult():
        ...
        if cmb_quest.get()=="CT:-1" or cmb_quest.get()=="CT:-2":
            ...
            try:
                ...
                strr="use Management"
                mycursor.execute(strr)
                strr="select * from PUT where RollNo=%s and Subject=%s and Exam=%s"
    ...
    daa = Label(addroot, text="DAA:-", font=("times", 20, "italic bold"), bg="lavender", relief=GROOVE, borderwidth=5,
                 width=15)
