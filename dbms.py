...
def addresut():
    def Subresult():
        ...
        if cmb_quest.get()=="CT:-1" or cmb_quest.get()=="CT:-2":
            ...
            try:
                ...
                mycursor.execute(strr, (roll,name,cmb_quest.get(),s,dbms, T))
                con.commit()
    ...
    dbms = Label(addroot, text="DBMS:-", font=("times", 20, "italic bold"), bg="lavender", relief=GROOVE, borderwidth=5,
                 width=15)
...
"RollNo", "Name", "Exam", "DBMS",  "TotalMarks"),
