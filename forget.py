...
def showresult():
    ...
    r=Radiobutton(searchroot,text="CT",padx=14,value="CT",font=("times", 15, "italic bold"),bg="maroon",variable=varval)
    r.place(x=100,y=135)

    r=Radiobutton(searchroot,text="PUT",padx=14,value="PUT",font=("times", 15, "italic bold"),bg="maroon",variable=varval)
    r.place(x=400,y=135)
...
def addresut():
    def Subresult():
        ...
        if cmb_quest.get()=="CT:-1" or cmb_quest.get()=="CT:-2":
            ...
            try:
                ...
                mycursor.execute(strr, (roll,name,cmb_quest.get(),s,daa, T))
                con.commit()
    ...
    daa = Label(addroot, text="DAA:-", font=("times", 20, "italic bold"), bg="grey", relief=GROOVE, borderwidth=5,
                 width=15)
    daa.place(x=10, y=250)
    ...
    daaentry = Entry(addroot, font=("times", 20, "italic bold"), relief=GROOVE, bd=5, textvariable=daaval)
    daaentry.place(x=280, y=250)
...
"RollNo", "Name", "Exam", "DAA",  "TotalMarks"),
...
StudentTable.heading("DAA", text="DAA")
...
StudentTable.column("DAA",width=90)
StudentTable.column("TotalMarks",width=210)
StudentTable.pack(fill=BOTH, expand=1)
# --------------------------------------------------------------------SliderWelcome
ss = "Design Analysis and Algorithm"
count = 0
text = " "
